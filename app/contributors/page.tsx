...
export default function Contributors() {
    return (
        <View>
            <Pane paddingX={20} paddingY={50}>
                <Heading size={700} fontWeight={500}>
                ...
                <b>
                    <a
                        href='https://www.princetonresinde.com/'
                        target='_blank'
                ...
                <br />
                <br />
                Want to learn more about the Hoagie as a student club? Fill out
                our
                <b>
                    <a
                        href='https://tally.so/r/mVzojm'
                        target='_blank'
                        rel='noopener noreferrer'
                    >
                        {' '}
