...
export default function SuccessPage({ digest = false }) {
    return (
        <Pane
            display='flex'
        ...
        >
            ...
            {digest && (
                <>
                    <Pane>
                        Your post has been added to Hoagie Stuff and will also
                        be added to the next Hoagie Digest, and will be included
                        in the upcoming weekly digest email. Digest emails are
                        sent{' '}
                        <b>at noon every Tuesday, Thursday, and Saturday</b> so
                        you can expect your message to be sent then.
                        <br /> <br />
                        If you would like to give feedback or are interested in
                        our future projects, feel free to contact us through
                        <b>
                            <a href='mailto:hoagie@princeton.edu'>
                                {' '}
                                hoagie@princeton.edu
